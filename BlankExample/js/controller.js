(function (window) {
	...
	Controller.prototype.showAll = function () {
		var that = this;
		that.model.read().then(function (data) {
	...
	Controller.prototype.showActive = function () {
		var that = this;
		that.model.read({ completed: false }).then(function (data) {
			that.view.render('showEntries', data);
		});
	};
	...
	Controller.prototype.showCompleted = function () {
		var that = this;
		that.model.read({ completed: true }).then(function (data) {
			that.view.render('showEntries', data);
		});
	};
	...
	Controller.prototype.addItem = function (title) {
		...
		that.model.create(title).then(function () {
	...
	Controller.prototype.editItem = function (id) {
		var that = this;
		that.model.read(id).then(function (data) {
	...
	Controller.prototype.editItemSave = function (id, title) {
		var that = this;
		if (title.trim()) {
			that.model.update(id, { title: title }).then(function () {
	...
	Controller.prototype.removeItem = function (id) {
		var that = this;
		that.model.remove(id).then(function () {
	...
	Controller.prototype.toggleComplete = function (id, completed, silent) {
		var that = this;
		that.model.update(id, { completed: completed }).then(function () {
	...
	Controller.prototype.toggleAll = function (completed) {
		var that = this;
		that.model.read({ completed: !completed }).then(function (data) {
			data.forEach(function (item) {
	...
	Controller.prototype._updateCount = function () {
		var that = this;
		that.model.getCount().then(function (todos) {
